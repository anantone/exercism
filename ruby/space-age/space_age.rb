# Given an age in (Earth) seconds, returns its equivalent in local orbital years
# for each solar system planet, when called with `on_planet_name` (`on_mercury`, `on_earth`)
class SpaceAge
